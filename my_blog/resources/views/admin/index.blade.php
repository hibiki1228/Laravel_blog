            ...
            <div class="container w-100">
                <div class="row row-cols-auto gap-4 justify-content-center">
                    @foreach ($blog_infos as $blog_info)
                        ...
                        <a class="col d-flex justify-content-between align-items-center flex-column gap-2"
                            style="text-decoration: none;"
                            href="{{ route('blogs.show', ['blog_id' => $blog_info->id]) }}">{{ $blog_info->title }}</a>

                        <h3 class="text-dark">{{ $blog_info->body }}</h3>
                        <br>
                        <br>
                    @endforeach
                </div>
